...
(function(){
    $(function(){
        ...
        if(window.quickReplyflag) {
            ...
            var float_ask_img="<div data-mod='popu_64' class='tracking-ad' chg-blk='0' ><!-- <a id='com-appcode-float-block' href='http://www.csdn.net/app/' target='_blank' title='APP二维码' style='top:"+(back_top_value-160)+"px'><span id='appcode-close'></span></a> <a id='com-app-float-block'  href='http://www.csdn.net/app/' title='APP下载' style='top:"+(back_top_value-76)+"px'></a> -->"+
                "<a id='com-edu-call-center'  title='学院客服' style='top:"+(back_top_value-38)+"px' target='_blank' href='http://wpa.qq.com/msgrd?v=3&amp;uin=2355263780&amp;site=qq&amp;menu=yes'></a>"+
                "<a id='com-d-top-a'  style='top:"+back_top_value+"px' title='返回顶部' onclick='' ></a></div>";
        } else if (window.bbsInfoflag) {
            var float_ask_img="<div data-mod='popu_64' class='tracking-ad' chg-blk='0' ><a id='com-appcode-float-block' href='http://www.csdn.net/app/' target='_blank' title='APP二维码' style='top:"+(back_top_value-236)+"px'><span id='appcode-close'></span></a><a id='com-app-float-block'  href='http://www.csdn.net/app/' title='APP下载' style='top:"+(back_top_value-152)+"px'></a>"+
                "<a id='com-quick-reply-bbs' title='快速回复' style='top:"+(back_top_value-114)+"px'></a>" +
        ...
        //再次重新加入ask供商务项目那边使用20150610
            ...
            var float_ask_img="<div data-mod='popu_64' class='tracking-ad' chg-blk='0' ><a id='com-appcode-float-block'  href='http://www.csdn.net/app/' target='_blank' title='APP二维码' style='top:"+(back_top_value-122)+"px'><span id='appcode-close'></span></a><a id='com-app-float-block'   href='http://www.csdn.net/app/' title='APP下载' style='top:"+(back_top_value-38)+"px'></a>"+
                "<a id='com-d-top-a'  style='top:"+back_top_value+"px' title='返回顶部' onclick='' ></a></div>";
        }
