...
public class TestDecorator {
	...
	public static void main(String[] args) {
		ChickenHamburge ch = new ChickenHamburge();		
        
        Hamburge bd = new BeefDecorator(new EggDecorator(ch));
        bd.product();
	}
